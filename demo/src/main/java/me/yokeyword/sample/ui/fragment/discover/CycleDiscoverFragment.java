 ...
 */
public class CycleDiscoverFragment extends BaseBackFragment {
    ...
    public static CycleDiscoverFragment newInstance(int number) {
        CycleDiscoverFragment fragment = new CycleDiscoverFragment();
    ...
    private void initView(View view) {
        ...
        String title = "发现:循环Fragment" + mNumber;
        ...
        mBtnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                start(CycleDiscoverFragment.newInstance(mNumber + 1));
            }
        });
